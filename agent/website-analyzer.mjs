const FEATURE_KEYWORDS = [
  ...
  { name: "Overview", terms: ["overview", "summary", "highlights", "snapshot", "dashboard overview"] },
  ...
  { name: "History", terms: ["history", "recent", "saved", "archive", "recent activity"] },
  { name: "Compare", terms: ["compare", "comparison", "versus", "vs", "side by side"] },
  { name: "Data Visualization", terms: ["chart", "charts", "graph", "graphs", "visualization", "trend", "trends", "metric", "metrics"] },
  { name: "Trends", terms: ["trend", "trends", "trendline", "trend lines", "moving average"] },
